...
class RequestBody(BaseModel):
    prompt: str
    negative_prompt: Optional[str] = Field(default="", max_length=300)
    steps: Optional[int] = Field(default=8, ge=4, le=100)
    num_of_images: Optional[int] = Field(default=1, ge=1, le=20)
